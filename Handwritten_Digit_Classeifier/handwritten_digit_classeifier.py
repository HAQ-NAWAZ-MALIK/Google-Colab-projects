# -*- coding: utf-8 -*-
"""Handwritten Digit Classeifier.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OIicHjbxCnUQu-nceV_OpTtM1JooUI8N
"""
...
# prompt: print the image

plot_multi(0)

# prompt: now from the above image recognise the digits and print them

for i in range(16):
  prediction = mlp.predict([x_test[i]])
  print(f"Prediction: {prediction[0]}, Actual: {y_test[i]}")
